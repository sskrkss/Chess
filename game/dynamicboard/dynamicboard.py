...
class DynamicBoard(StaticBoard):
    def move(self, h1, v1, h2, v2, turn):  # вынести в отдельный интерфейс
        ...
        elif isinstance(selected_cell, King) and (h2, v2) == selected_cell.is_short_castling(self.board):
            h = h2
        ...
        elif isinstance(selected_cell, King) and (h2, v2) == selected_cell.is_long_castling(self.board):
            h = h2
